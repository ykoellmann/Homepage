...
export const aboutPageData: BasePageData & {
    ...
    experiences: [
        ...
        },
        {
            ...
            location: 'Gronau, Nordrhein-Westfalen, Deutschland',
            employmentType: 'Vollzeit',
            skills: ['C#', 'ASP.NET Core', 'API-Entwicklung', 'Entity Framework Core', 'SQL', 'TypeScript', 'HTML5', 'Angular'],
            description: 'Backend-Entwicklung mit Fokus auf Vertriebssysteme und interne IT-Lösungen - Entwicklung von APIs, Services und Tools zur Unterstützung der Vertriebsabteilung',
        },
        {
        ...
        },
        {
            ...
            endMonth: 'Aug. 2021',
            position: 'Abitur',
            location: 'Steinfurt, Nordrhein-Westfalen, Deutschland',
            skills: [],
            description: 'Allgemeine Hochschulreife (Betriebswirtschaftslehre)',
        },
    ],
};
